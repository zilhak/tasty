...
- `disallowed-methods` — 색을 "디자인" 하는 함수의 목록. 우연한 호출을 차단한다 ([theme › 색 생성 정책](../design/systems/theme.md#색-생성-정책)). 옛 pre-commit C.8 이 이리로 이관됐다.
