...
| [child-completion-app-server](child-completion-app-server.md) | Codex 부모의 바인딩·영속 outbox·unknown 복구와 release/tell 구독 수명 · 논리 소유권·등록 전 관계 해제·실행별 오류 관측·절대 I/O 시간 제한 |
