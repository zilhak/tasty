...
- [ADR-0016](../adr/0016-window-platform-and-shutdown.md) · [gpu-rendering.md](gpu-rendering.md) — 이벤트 루프 stall 워치독의 결정 근거와 렌더 구조
