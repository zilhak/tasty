...
- **좌측 클러스터**(표시 전용, 순서 고정): `git-branch` 글리프(`statusbar-glyph`, `icon-size-xs` 12) + 이름 · surface id · shell · grid.
...
- **우측 클러스터**(clickable): 팔레트 단축키 **Kbd 키캡**(라벨 단어 없음) · 테마 **글리프**(이름 없음, `statusbar-theme-glyph`).
