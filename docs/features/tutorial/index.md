...
메뉴에서 열며, 각 step 이 화면의 특정 영역(워크스페이스/탭헤더/패인/서피스)에 **사각테두리
...
- **첫 주제** = "워크스페이스 · 패인 · 탭 · 서피스" 4 step: 워크스페이스(콘텐츠 전체영역) →
  탭 헤더(pane 상단 띠) → 패인(pane rect) → 서피스(surface rect). 마커가 점점 좁혀지며
  포함관계를 드러낸다.
