...
| [terminal](terminal/index.md) — 터미널 (PTY·VTE·앱별 Shift+Enter·보조키 방향키·scrollback·GPU) | 로컬 사용자 · AI Agent · 원격 | GPU 그리드 |
...
| [macos-permissions](macos-permissions/index.md) — macOS 권한 (TCC 파일·화면 기록 pre-warm, 미승인 권한 안내) | 로컬 사용자 | [설정 탭](settings/screens/settings.md) 일반 > 권한 |
