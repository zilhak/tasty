...
생성 시 cwd 가 *손실 없이 carry* 되는 invariant 는 [`docs/architecture/surface-cwd-invariant.md`](../architecture/surface-cwd-invariant.md) 참조. 본 문서는 **각 surface 가 자기 cwd 를 *어떻게 정의하고 갱신하는가*** 를 다룬다.
...
- [`docs/architecture/surface-cwd-invariant.md`](../architecture/surface-cwd-invariant.md) — 생성 시 cwd carry invariant
