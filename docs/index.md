...
| 문서 | 설명 |
|------|------|
| [agent-guide/index.md](agent-guide/index.md) | 에이전트 가이드 개요 + 환경별 링크 |
| [agent-guide/api-reference.md](agent-guide/api-reference.md) | IPC/CLI 전체 레퍼런스 (플랫폼 공통) |
| [agent-guide/linux.md](agent-guide/linux.md) | Linux 환경 가이드 (실행 확인, 프로세스 관리, 경로) |
