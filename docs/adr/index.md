...
| 0040 | [점유를 약한/강한(soft/hard) 2계층으로 나누고 AI 에이전트를 점유 주체로 일반화](0040-occupancy-soft-hard-tiers-agent-occupant.md) | Proposed | 2026-07-07 | occupation, soft-occupy, hard-occupy, actors, ai-agent, child-terminal, attach, readonly, marker, focus-independence, adr-0007, adr-0032 |
