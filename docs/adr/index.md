...
| 0054 | [원격 파일 바이트 전송(bulk)은 attach 스트림 위 native binary 채널로 구현한다 (sftp/SMB 등은 이 기능에 미사용)](0054-remote-filesystem-native-over-attach-stream.md) | Proposed | 2026-07-23 | remote, attach, mirror, file-transfer, native-protocol, stream, bulk-channel, no-base64, ssh-delegation, cross-platform, adr-0007, adr-0032, adr-0045 |
