...
- 코드: `crates/tasty-remote-profiles/`(모델·마이그레이션) · `src/adapters/ipc/handler/remote_profile.rs` · `src/adapters/ui/popup/remote_tool.rs` · `crates/tasty-cli/src/commands/ssh_profile.rs`
