...
- 부분 개정: [0568](0568-a-user-gesture-navigation-in-a-plugin-webview-makes-its-file-dispatch-a-user-action.md) ("세 조건이 모두 맞을 때만 사용자로 친다" 조항 개정 — 엔진이 사용자 제스처로 보고한 자기 webview 의 navigation 도 근거가 된다)
