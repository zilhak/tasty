...
[![Workspace](https://img.shields.io/badge/workspace-54%20crates-orange)](crates/)
...
- **Hexagonal architecture** — model + ports + adapters + view + host_api separation, 54-crate workspace.
...
A hexagonal architecture (model + ports + adapters + view + host_api separation) across a 54-crate workspace. Full structure: [`docs/architecture/`](docs/architecture/).
