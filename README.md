...
[![Workspace](https://img.shields.io/badge/workspace-56%20crates-orange)](crates/)
...
- **Hexagonal architecture** — model + ports + adapters + view + host_api separation, 56-crate workspace.
...
A hexagonal architecture (model + ports + adapters + view + host_api separation) across a 56-crate workspace. Full structure: [`docs/architecture/`](docs/architecture/).
