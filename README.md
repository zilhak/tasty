...
[![Workspace](https://img.shields.io/badge/workspace-59%20crates-orange)](crates/)
...
- **Hexagonal architecture** — model + ports + adapters + view + host_api separation, 59-crate workspace.
...
A hexagonal architecture (model + ports + adapters + view + host_api separation) across a 59-crate workspace. Full structure: [`docs/architecture/`](docs/architecture/).
