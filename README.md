...
[![Workspace](https://img.shields.io/badge/workspace-52%20crates-orange)](crates/)
...
- **Hexagonal architecture** — model + ports + adapters + view + host_api separation, 52-crate workspace.
...
A hexagonal architecture (model + ports + adapters + view + host_api separation) across a 52-crate workspace. Full structure: [`docs/architecture/`](docs/architecture/).
