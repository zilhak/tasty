...
[![Workspace](https://img.shields.io/badge/workspace-55%20crates-orange)](crates/)
...
- **Hexagonal architecture** — model + ports + adapters + view + host_api separation, 55-crate workspace.
...
A hexagonal architecture (model + ports + adapters + view + host_api separation) across a 55-crate workspace. Full structure: [`docs/architecture/`](docs/architecture/).
