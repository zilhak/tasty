...
Tasty 는 Windows · macOS · Linux 에서 똑같이 동작하는 GPU 가속 터미널입니다. 한 창 안에 여러 워크스페이스를 두고, 각 워크스페이스를 패인 · 탭 · 분할로 나눠 씁니다. 사람이 키보드로 하는 거의 모든 일을 `tasty` CLI 로도 할 수 있어서, Claude Code · Codex 같은 AI 코딩 에이전트가 터미널을 직접 다루게 만들 수 있습니다.
