...
저장하지 못하면(예: 읽기 전용 폴더) **내보내기** 행 안에 **내보내기 파일을 쓰지 못했습니다** <!-- en: The export wasn't written --> 가 뜹니다. **다시 시도** <!-- en: Try again --> 로 같은 자리에 다시 쓰거나 **다른 위치 고르기…** <!-- en: Choose another location… --> 로 다른 곳을 고릅니다. 이 안내가 떠 있는 동안 **내보내기…** 버튼은 눌리지 않습니다.
