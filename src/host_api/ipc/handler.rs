...
fn route_debug_handler(
    ...
    Some(match request.method.as_str() {
        ...
        "debug.cell_info" => debug::handle_debug_cell_info(state, id, &request.params),
        "debug.screen_attrs" => debug::handle_debug_screen_attrs(state, id, &request.params),
        "debug.glyph_color" => debug::handle_debug_glyph_color(state, id, &request.params),
        "debug.feed_bytes" => debug::handle_debug_feed_bytes(state, id, &request.params),
        "debug.inject_mouse" => debug::handle_debug_inject_mouse(state, id, &request.params),
        "debug.inject_key" => debug::handle_debug_inject_key(state, id, &request.params),
