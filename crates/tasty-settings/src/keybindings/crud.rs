...
impl KeybindingSettings {
    ...
    pub const GENERAL_BINDING_FIELDS: &'static [(&'static str, &'static str)] = &[
        ...
        (
            "open_port_scanner",
            "settings.keybindings.open_port_scanner_label",
        ),
        (
            "open_remote_tool",
            "settings.keybindings.open_remote_tool_label",
        ),
        (
            "open_preset_window",
            "settings.keybindings.open_preset_window_label",
        ),
        ("open_tutorial", "settings.keybindings.open_tutorial_label"),
        (
            "open_file_picker",
            "settings.keybindings.open_file_picker_label",
        ),
        (
    ...
    pub fn get_bindings(&self, field_id: &str) -> Option<&[String]> {
        Some(match field_id {
            ...
            "open_port_scanner" => self.open_port_scanner.as_slice(),
            "open_remote_tool" => self.open_remote_tool.as_slice(),
            "open_preset_window" => self.open_preset_window.as_slice(),
            "open_tutorial" => self.open_tutorial.as_slice(),
            "open_file_picker" => self.open_file_picker.as_slice(),
    ...
    fn get_bindings_mut(&mut self, field_id: &str) -> Option<&mut Vec<String>> {
        Some(match field_id {
            ...
            "open_port_scanner" => &mut self.open_port_scanner,
            "open_remote_tool" => &mut self.open_remote_tool,
            "open_preset_window" => &mut self.open_preset_window,
            "open_tutorial" => &mut self.open_tutorial,
            "open_file_picker" => &mut self.open_file_picker,
