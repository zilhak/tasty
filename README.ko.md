...
- **Hexagonal 아키텍처** — model + ports + adapters + view + host_api 분리, 59-crate workspace.
...
Hexagonal 아키텍처(model + ports + adapters + view + host_api 분리)의 59-crate workspace. 자세한 구조: [`docs/architecture/`](docs/architecture/).
