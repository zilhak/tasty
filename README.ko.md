...
- **Hexagonal 아키텍처** — model + ports + adapters + view + host_api 분리, 52-crate workspace.
...
Hexagonal 아키텍처(model + ports + adapters + view + host_api 분리)의 52-crate workspace. 자세한 구조: [`docs/architecture/`](docs/architecture/).
