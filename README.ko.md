...
- **Hexagonal 아키텍처** — model + ports + adapters + view + host_api 분리, 56-crate workspace.
...
Hexagonal 아키텍처(model + ports + adapters + view + host_api 분리)의 56-crate workspace. 자세한 구조: [`docs/architecture/`](docs/architecture/).
